...
#include <LED.h>
#include <Mower.h>
#include "NRF24L01_master.h"  // 'NRF24L01_chassis.h' needs to be placed inside an individual folder, otherwise an error always pops out here when we compile this sketch
...
//JoystickPosX = joystick1.getjoystickPosX(); //<-- Should come from the controller over radio communication
//JoystickPosY = joystick1.getjoystickPosY(); //<-- Should come from the controller over radio communication
