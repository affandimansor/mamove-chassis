...
CutterMotor cuttermotor1(34); // Cannot connect to a PWM port due to a reason that the output port needs to give out EXACTLY 5V to the relay. Otherwise the relay wouldn't work.
                              // Proof: Before this try to connect to port 8, output from this port then connected to a LED. This LED is dimmer compare to when the output port is port 34.
ChassisMotor chassismotor1(30,31,4,MOWER::MOTOR1);  // (IN1, IN2, EN1, MOWER::MotorIndex)
ChassisMotor chassismotor2(40,41,13,MOWER::MOTOR2); // (IN3, IN4, EN2, MOWER::MotorIndex)
...
void setup() {
  ...
  combinemotor.setChassisLED(&forwardLED, &reverseLED);
   ...
   // pinMode(7,OUTPUT); // Assign Pin 7 as output port just to test if the 5V-relay is functioning.
                         // Conclusion: Relay is not functioning when its conected to a PWM port. It might be due to the 
                         // PWM frequency, which causes 5V is not being exactly drawn from the PWM port.
...
//Serial.println(chassismotor1.mteta);
//Serial.print("--->Motor1 RADIUS:  ");
//Serial.println(chassismotor1.mradius);
Serial.print("Motor1 Direction:  ");
Serial.println(chassismotor1.getMotorDirection());
...
//Serial.println(chassismotor2.mteta);
//Serial.print("--->Motor2 RADIUS:  ");
//Serial.println(chassismotor2.mradius);
Serial.print("Motor2 Direction:  ");
Serial.println(chassismotor2.getMotorDirection());
...
//Serial.print("Cutter motor status: ");
//Serial.println(cuttermotor1.getMotorStatus());
/*
