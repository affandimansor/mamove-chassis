...
LED chassisLED1(32);
LED chassisLED2(42);
LED forwardLED(22); // LED to indicate the chassis moves forward
LED reverseLED(23); // LED to indicate the chassis moves backward/reverse
...
NRF_SetRxMode();
    if(NRF_Receive(rx_buf))
    {
        ...
        autoforwardswitchStatus = rx_buf[2];
        Serial.print("RY = ");
        Serial.println(JoystickPosY);
        cutterswitchStatus = rx_buf[3];
