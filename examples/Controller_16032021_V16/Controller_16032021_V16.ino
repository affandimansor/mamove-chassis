...
//JoystickPosX = 10;
//JoystickPosY = 20;
//JoystickPosX = joystick1.getjoystickPosX_new(); //<-- To be transmitted over radio communication to chassis!!!
//JoystickPosY = joystick1.getjoystickPosY_new(); //<-- To be transmitted over radio communication to chassis!!!
