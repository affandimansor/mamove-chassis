...
// Data to be transmitted over the radio communication 
  tx_buf[0] = 100;//JoystickPosX;//map(analogRead(JoyStick_X_PIN), 0, 1023, 0, 255);
  tx_buf[1] = 200;//JoystickPosY;//map(analogRead(JoyStick_Y_PIN), 0, 1023, 0, 255);
  tx_buf[2] = 300;//cutterswitchStatus;
  Serial.println("-----------");
  Serial.print("x:");
