...
Switch switchautoforward(6);
Potentiometer potentiocutter(3);
LED switchcutterLED(5);
...
Serial.print(autoforwardswitchStatus);
...
// Data to be transmitted over the radio communication 
  ...
  tx_buf[4] = potentiocutter.getPotentioValue();//cutterSpeed;
  /*Serial.println("-----------");
  Serial.print("x:");
