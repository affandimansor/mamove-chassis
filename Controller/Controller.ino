...
*/
float JoystickPosX = joystick1.getjoystickPosX();
float JoystickPosY = joystick1.getjoystickPosY();
...
int cutterswitchStatus = switchcutter.getSwitchStatus();
...
if(cutterswitchStatus == MOWER::ONOFF_Status::ON)
{
...
else // (cutterswitchStatus == MOWER::ONOFF_Status::ON)
{
  CutterMotorSpeed = 0;
